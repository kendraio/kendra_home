 ...
 */
function kendra_seven_preprocess_maintenance_page(&$vars) {
 ...
 */
function kendra_seven_preprocess_html(&$vars) {
 ...
 */
function kendra_seven_preprocess_page(&$vars) {
 ...
 */
function kendra_seven_node_add_list($variables) {
 ...
 */
function kendra_seven_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function kendra_seven_tablesort_indicator($variables) {
 ...
 */
function kendra_seven_css_alter(&$css) {
